...
public class UserValidator {
    ...
    public static void isLoginEmpty(User user) {
    ...
    public static void isBirthdayValid(User user) {
    ...
    public static void validateUserForCreation(User user, Map<Long, User> users) {
        isMailEmpty(user);
